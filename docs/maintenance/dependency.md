...
`spreetail-react` does not use "^", "~", etc., and these should be removed from `package.json`, if present. See [#598](https://github.com/spreetail-react/spreetail-react/issues/598) for more details.
...
```bash
   ...
   /home/travis/build/gihrig/spreetail-react/node_modules/react-router-scroll/lib'
...
- `history` Incompatible
  ...
  spreetail-react@3.4.0 /Users/glen/Documents/JavaScript/Research/react-bp
...
- Error: (some OS X installations only, not version specific)
  ...
  Referenced from: ~/spreetail-react/node_modules/mozjpeg/vendor/cjpeg
  Reason: image not found

  **_image-webpack-loader 2.0.0 → 3.0.0 <--- rolled back_**
  see: https://github.com/mxstbr/spreetail-react/pull/1322#issuecomment-266264527 and #1335
