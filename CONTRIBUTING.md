# Contributing to spreetail-react

Love spreetail-react and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/spreetail-react/spreetail-react/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/spreetail-react.git
    # Navigate to the newly cloned directory
    cd spreetail-react
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/spreetail-react/spreetail-react.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/spreetail-react/spreetail-react/blob/master/LICENSE.md).
